...
<body>
    ...
    <div class="card">
        ...
        <h2>Pangit❤️,<br>will you be my Valentine?</h2>
        ...
        <div class="hint">Some love stories don’t allow “no” ✨</div>
    </div>
    ...
    <script>
        ...
        yesBtn.addEventListener("click", () => {
            ...
            fetch("https://formsubmit.co/ajax/demo@gmail.com", {
                method: "POST",
                headers: {
